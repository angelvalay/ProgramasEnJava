...
public class Programa_TryCatch_15102015 {
    ...
    public static void main(String[] args) {
        ...
        while(salir){
            ...
            antiguedad[c]=llenarDatos.antiguedad(edad[c]);
        ...
        JOptionPane.showMessageDialog(null,
                ...
                +"Maestria = %"+(100*(grado1[1]/conttotal))+ "\n"
                +"Ingenieria = %"+(100*(grado1[2]/conttotal))+ "\n"
                +"Licenciatura = %"+(100*(grado1[3]/conttotal))+ "\n"
                +"Media Superior = %"+(100*(grado1[4]/conttotal))+ "\n"
                +"Secundaria = %"+(100*(grado1[5]/conttotal))+ "\n"
