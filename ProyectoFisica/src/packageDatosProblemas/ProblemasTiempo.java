 ...
 */
public class ProblemasTiempo extends Problemas{
    
    public ProblemasTiempo(String problema, float distancia, String tDistancia, float tiempo, String tTiempo, float rapidez, String tRapidez) {
