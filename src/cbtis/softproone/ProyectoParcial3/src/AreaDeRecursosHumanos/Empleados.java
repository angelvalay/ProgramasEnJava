...
import cbtis.softproone.ProyectoParcial3.src.AdministracionTotal.Conexion;
import cbtis.softproone.ProyectoParcial3.src.AdministracionTotal.InicioAdmin;
   ...
   private boolean sexo(){
    ...
    public void tableBusqueda(){
        ...
        try {
            ...
            Logger.getLogger(AreaDeRecursosHumanos.EmpleadosLista.class.getName()).log(Level.SEVERE, null, ex);
        } 
