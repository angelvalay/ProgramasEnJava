...
public class mesesCasa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        meses.setBackground(new java.awt.Color(255, 0, 0));
        meses.setForeground(new java.awt.Color(255, 204, 204));
        meses.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12", "24", "36", "48" }));
    ...
    private void SíActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SíActionPerformed
        PedirDatos.MESES=mesesCasa.meses.getSelectedIndex();
