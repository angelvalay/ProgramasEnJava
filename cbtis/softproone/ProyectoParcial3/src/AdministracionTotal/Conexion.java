...
public static Connection GetConnection()
   ...
   public static Connection GetResetearConnection()
    {
        ...
        pasw= JOptionPane.showInputDialog(null, "Ingresa la contraseña",null, JOptionPane.INFORMATION_MESSAGE);
           ...
           JOptionPane.showMessageDialog(null, "Conexion Fallida. Vuelve a intentarlo, mas tarde."+a.getMessage(), null, JOptionPane.WARNING_MESSAGE);
        }
        ...
        {
            JOptionPane.showMessageDialog(null, "Ocurrio un error. Vuelve a intentarlo, mas tarde"+ ex.getMessage(), "Error", JOptionPane.WARNING_MESSAGE);
            conexion=null;
   ...
   //GET NUEVA COMPRA
    ...
    public void setReport(String reporte){
        try{
            String registro= "insert into reportes(fecha,reporte) values"
                    + "('"+this.FECHA+"',"+"'"+reporte+"')";
            con.executeUpdate(registro);
